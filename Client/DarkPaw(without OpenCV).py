...
def loop():  # GUI
    ...
    while True:
        ...
        ################################
        Btn_Smooth = tk.Button(
            root, width=8, text="Smooth", fg=color_text, bg=color_btn, relief="ridge"
        )
        ...
        Btn_left = tk.Button(
            root, width=8, text="Low", fg=color_text, bg=color_btn, relief="ridge"
        )
        Btn_right = tk.Button(
            root, width=8, text="High", fg=color_text, bg=color_btn, relief="ridge"
        )
        Btn_home = tk.Button(
        ...
        Btn_Steady = tk.Button(
            root, width=10, text="Steady", fg=color_text, bg=color_btn, relief="ridge"
        )
