        ...
        if pos == 1:
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2,
                    0,
                    int(pwm2 - reach_wiggle - increase * (max_wiggle - reach_wiggle)),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2,
                    0,
                    int(pwm2 - max_wiggle + increase * (max_wiggle - reach_wiggle)),
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 - increase * wiggle))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - reach_wiggle + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 - wiggle + increase * wiggle / 3))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - 5 * reach_wiggle / 6 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 - 2 * wiggle / 3 + increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - reach_wiggle / 6 - increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - 2 * reach_wiggle / 3 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 - wiggle / 3 + increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - reach_wiggle / 3 - increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - reach_wiggle / 2 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 + increase * wiggle / 3))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    2, 0, int(pwm2 - 2 * reach_wiggle / 6 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(0, 0, int(pwm0 + wiggle / 3 + increase * wiggle / 3))
        ...
        if pos == 1:
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5,
                    0,
                    int(pwm5 + reach_wiggle + increase * (max_wiggle - reach_wiggle)),
                )
            else:
                pwm.set_pwm(3, 0, int(pwm3 - wiggle + increase * wiggle))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5,
                    0,
                    int(pwm5 + max_wiggle - increase * (max_wiggle - reach_wiggle)),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + reach_wiggle - increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + reach_wiggle / 6 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(3, 0, int(pwm3 + 2 * wiggle / 3 - increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + 5 * reach_wiggle / 6 - increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + reach_wiggle / 3 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(3, 0, int(pwm3 + wiggle / 3 - increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + 2 * reach_wiggle / 3 - increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    5, 0, int(pwm5 + reach_wiggle / 2 + increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(3, 0, int(pwm3 - increase * wiggle / 3))
        ...
        if pos == 1:
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8,
                    0,
                    int(pwm8 + reach_wiggle + increase * (max_wiggle - reach_wiggle)),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8,
                    0,
                    int(pwm8 + max_wiggle - increase * (max_wiggle - reach_wiggle)),
                )
            else:
                pwm.set_pwm(6, 0, int(pwm6 + increase * wiggle))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + reach_wiggle - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(6, 0, int(pwm6 + wiggle - increase * wiggle / 3))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + 5 * reach_wiggle / 6 - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(6, 0, int(pwm6 + 2 * wiggle / 3 - increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + reach_wiggle / 6 + increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + 2 * reach_wiggle / 3 - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(6, 0, int(pwm6 + wiggle / 3 - increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + reach_wiggle / 3 + increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    8, 0, int(pwm8 + reach_wiggle / 2 - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(6, 0, int(pwm6 - increase * wiggle / 3))
        ...
        if pos == 1:
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11,
                    0,
                    int(pwm11 - reach_wiggle - increase * (max_wiggle - reach_wiggle)),
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 + wiggle - increase * wiggle))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11,
                    0,
                    int(pwm11 - max_wiggle + increase * (max_wiggle - reach_wiggle)),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - reach_wiggle + increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - reach_wiggle / 6 - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 - 2 * wiggle / 3 + increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    11,
                    0,
                    int(pwm11 - 5 * reach_wiggle / 6 + increase * reach_wiggle / 6),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    10, 0, int(pwm10 + 5 * wiggle / 12 + increase * wiggle / 12)
                )

                pwm.set_pwm(
                    11, 0, int(pwm11 - reach_wiggle / 3 - increase * reach_wiggle / 6)
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 - wiggle / 3 + increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    11,
                    0,
                    int(pwm11 - 2 * reach_wiggle / 3 + increase * reach_wiggle / 6),
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - reach_wiggle / 2 - increase * wiggle / 6)
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 + increase * wiggle / 3))
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - reach_wiggle / 2 + increase * reach_wiggle / 6)
                )
                pass
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - 2 * reach_wiggle / 3 - increase * wiggle / 6)
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 + wiggle / 3 + increase * wiggle / 3))
            ...
            if direction:
                ...
                pwm.set_pwm(
                    11, 0, int(pwm11 - 5 * reach_wiggle / 6 - increase * wiggle / 6)
                )
            else:
                pwm.set_pwm(9, 0, int(pwm9 + 2 * wiggle / 3 + increase * wiggle / 3))
...
def ctrl_pitch_roll(wiggle, pitch, roll):
    ...
    pwm.set_pwm(
        ...
        0,
        ctrl_range(
            (pwm1 - wiggle * pitch / 100 - wiggle * roll / 100), pwm1_max, pwm1_min
        ),
    )
    ...
    pwm.set_pwm(
        ...
        0,
        ctrl_range(
            (pwm4 - wiggle * pitch / 100 + wiggle * roll / 100), pwm4_max, pwm4_min
        ),
    )
    ...
    pwm.set_pwm(
        ...
        0,
        ctrl_range(
            (pwm7 + wiggle * pitch / 100 - wiggle * roll / 100), pwm7_max, pwm7_min
        ),
    )
    ...
    pwm.set_pwm(
        ...
        0,
        ctrl_range(
            (pwm10 + wiggle * pitch / 100 + wiggle * roll / 100), pwm10_max, pwm10_min
        ),
    )
